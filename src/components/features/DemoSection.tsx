  ...
  return (
    <section className="relative bg-gradient-to-b from-gray-800 to-gray-900 py-32 overflow-hidden">
      <motion.div
        ...
        className="absolute inset-0 bg-[url('/quake-path/assets/turkey-map.webp')] bg-contain bg-no-repeat bg-center mix-blend-hard-light"
      />

      <div className="absolute inset-0 bg-[url('/quake-path/assets/turkey-map.webp')] opacity-10 mix-blend-overlay animate-pulse-slow" />
